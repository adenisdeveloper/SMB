...
class ParserTest extends \PHPUnit\Framework\TestCase {
	...
	public function testParseACLRealWorld() {
		...
		$expected = [
			...
			"DESKTOP\\binfotech"         => new ACL(ACL::TYPE_ALLOW, ACL::FLAG_CONTAINER_INHERIT + ACL::FLAG_OBJECT_INHERIT, ACL::MASK_DELETE + ACL::MASK_EXECUTE + ACL::MASK_WRITE + ACL::MASK_READ),
		];
